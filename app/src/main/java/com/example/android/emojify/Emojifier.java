...
class Emojifier {
    ...
    //  (3): Change all Log statements to Timber logs and remove the LOG_TAG variable
    ...
    static Bitmap detectFacesandOverlayEmoji(Context context, Bitmap picture) {
        ...
        Timber.d("detectFaces: number of faces = %i " , faces.size());
    ...
    private static Emoji whichEmoji(Face face) {
        ...
        Timber.d( "whichEmoji: leftEyeOpenProb = %f",
                face.getIsLeftEyeOpenProbability());
        Timber.d( "whichEmoji: rightEyeOpenProb = %f",
